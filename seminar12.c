...
Prajitura cautarePrajitura(int id, Nod* radacina) {
	if (!radacina) {
		return initPrajitura(-1, (char*)"Neinitializat", 0.0f);
	}
...
void main() {
	Nod* radacina = NULL;
	inserareInArboreAVL(initPrajitura(5, (char*)"Profiterol", 20), &radacina);
	inserareInArboreAVL(initPrajitura(2, (char*)"Amandina", 21.5), &radacina);
	inserareInArboreAVL(initPrajitura(7, (char*)"Cheesecake", 30), &radacina);
	inserareInArboreAVL(initPrajitura(4, (char*)"Ecler", 16), &radacina);
	inserareInArboreAVL(initPrajitura(8, (char*)"Lavacake", 30), &radacina);
	inserareInArboreAVL(initPrajitura(6, (char*)"Negresa", 21), &radacina);
